...
import java.util.ArrayList;                               // 컬렉션 자료구조
...
import java.util.concurrent.atomic.AtomicReference;        // 스레드 안전한 참조 저장소
import java.util.regex.Pattern;                           // 정규식 패턴
import java.util.stream.Collectors;                       // 스트림 컬렉터

import org.apache.commons.text.similarity.CosineSimilarity; // 코사인 유사도 계산기
import org.slf4j.Logger;                                   // SLF4J 로깅
import org.slf4j.LoggerFactory;
import org.springframework.stereotype.Component;            // 스프링 빈 등록

import io.swagger.v3.oas.models.OpenAPI;                   // OpenAPI 모델 객체
import io.swagger.v3.oas.models.Operation;                 // API operation 정보
import io.swagger.v3.oas.models.PathItem;                  // HTTP 메서드와 Path 정보
import io.swagger.v3.oas.models.media.Schema;              // 응답 스키마 정보
import io.swagger.v3.oas.models.parameters.Parameter;       // 요청 파라미터 정보
import io.swagger.v3.oas.models.responses.ApiResponse;      // 응답 정보
import io.swagger.v3.parser.OpenAPIV3Parser;                // OpenAPI 파서
import io.swagger.v3.parser.core.models.ParseOptions;       // 파싱 옵션
import io.swagger.v3.parser.core.models.SwaggerParseResult; // 파싱 결과 객체
